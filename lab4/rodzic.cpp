...
Rodzic::Rodzic():imie(""),nazwisko(""),wiek(0),potomek()
{}

Rodzic::Rodzic(string _imie, string _nazwisko, int _wiek, Dziecko _potomek):imie(_imie),nazwisko(_nazwisko),wiek(_wiek),potomek(_potomek)
{}
